...
export class UserService {
    ...
    public async checkUserEmail (email: string): Promise<any> {
        return await httpsCallable(this.fns, 'checkUserEmail')({email: email});
    };

    public async checkUserCelNumber(celNumber: string): Promise<any> {
        return await httpsCallable(this.fns, 'checkUserCelNumber')({celNumber: celNumber});
    }
